...
*/
#ifndef ALGORITHM_CPP_ACSHELLSORT_H
#define ALGORITHM_CPP_ACSHELLSORT_H
#include "ACInsertSort.h"
template<typename T,  typename N>
class ACShellSort : public ACInsertSort<T, N> {
public:
   void sort(T* data, const N &n) override;
};
#include "ACShellSort.tpp"
#endif //ALGORITHM_CPP_ACSHELLSORT_H
